    ...
    public class MockProductRepository : IProductRepository
    {
        ...
        public IEnumerable<Product> AllProducts =>
            new List<Product>
            {
                ...
                new Product { ProductId = 4, Name = "Coca-Cola", Price=1.84M, ShortDescription = "Coca-Cola soft drink, 2L", LongDescription = " ", Category = _categoryRepository.AllCategories.ToList()[3], ImageUrl = "~/Images/cola.jpg", InStock = true,  /*ImageThumbnailUrl*/ },
